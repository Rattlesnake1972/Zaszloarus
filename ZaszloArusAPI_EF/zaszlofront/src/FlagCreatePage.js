...
export function FlagCreatePage(){
    ...
    return (
        <div className="p-5 content bg-whitesmoke text-center">
            ...
            fetch(`https://localhost:7156/ZaszloArusAPI_EF`, {
                method: "POST",
                ...
                body: JSON.stringify({
                    ...
                    isRaktaronVan: event.target.elements.isglutenfree.value,
                    melyikorszag: event.target.elements.feltet.value,
            ...
            <div className="form-group row pb-3">
                <label className="col-sm-3 col-form-label">Raktáron van:</label>
                <div className="col-sm-9">
                <input type="number" name="israktaronvan" className="form-control" />
                </div>
            </div>
            <div className="form-group row pb-3">
                <label className="col-sm-3 col-form-label">Ország:</label>
                <div className="col-sm-9">
                <input type="text" name="melyikorszag" className="form-control" />
                </div>
            </div>
            <div className="form-group row pb-3">
